...
-- Description: Initial schema for AbsenQR Vibe (including division column in members)
...
CREATE TABLE IF NOT EXISTS attendances (
  ...
  member_id TEXT NOT NULL REFERENCES members(id),
  qr_token_id TEXT NOT NULL REFERENCES qr_tokens(id),
  session_type TEXT NOT NULL DEFAULT 'CHECKIN',
  scanned_at TEXT NOT NULL DEFAULT (datetime('now')),
  station_id TEXT,
  operator_id TEXT REFERENCES admins(id),
